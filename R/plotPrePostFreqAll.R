...
################################################################
#' @export
plotPrePostFreqAll <- function(preChavezTokenFrequency, postChavezTokenFrequency, WordsORStemsORLemmas="Words", isKeywords=FALSE){


  # # # #   ##FOR TESTING with Info Generated in Main Script ####
  # # # # #
  #  preChavezTokenFrequency <- preChavezLemmaFrequency
  # #
  #  postChavezTokenFrequency <- postChavezLemmaFrequency
  # #
...
topNWords = max(nrow(preChavezTokenFrequency), nrow(postChavezTokenFrequency))
