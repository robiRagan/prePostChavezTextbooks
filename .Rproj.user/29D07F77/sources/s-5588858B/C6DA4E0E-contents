...
###########################################################################
# Combine Frequency and Proportions for ALL Words, Stems and Lemmas

preChavezWordFreqAndProp <- inner_join(preChavezWordFrequency, preChavezWordProportion)
postChavezWordFreqAndProp <- inner_join(preChavezWordFrequency, preChavezWordProportion)

preChavezStemWordFreqAndProp <- inner_join(preChavezStemWordFrequency, preChavezStemWordProportion)
postChavezStemWordFreqAndProp <- inner_join(postChavezStemWordFrequency, postChavezStemWordProportion)

preChavezLemmaFreqAndProp <- inner_join(preChavezLemmaFrequency, preChavezLemmaProportion)
postChavezLemmaFreqAndProp <- inner_join(postChavezLemmaFrequency, postChavezLemmaProportion)
...
cosineSimilarityWordsAll <- findCosineSimilarity(preChavezTokenFrequency = preChavezWordFrequency, postChavezTokenFrequency = postChavezWordFrequency)
cosineSimilarityWordsAll

cosineSimilarityStemsAll <- findCosineSimilarity(preChavezTokenFrequency = preChavezStemWordFrequency, postChavezTokenFrequency = postChavezStemWordFrequency)
cosineSimilarityStemsAll


cosineSimilarityLemmasAll <- findCosineSimilarity(preChavezTokenFrequency = preChavezLemmaFrequency, postChavezTokenFrequency = postChavezLemmaFrequency)
cosineSimilarityLemmasAll


cosineSimilarityWordsKeywords <- findCosineSimilarity(preChavezTokenFrequency = preChavezWordFrequencyMasterKey, postChavezTokenFrequency = postChavezWordFrequencyMasterKey)
cosineSimilarityWordsKeywords



cosineSimilarityStemsKeywords <- findCosineSimilarity(preChavezTokenFrequency = preChavezFrequencyMasterKeyStems, postChavezTokenFrequency = postChavezFrequencyMasterKeyStems)
cosineSimilarityStemsKeywords


cosineSimilarityLemmasKeywords <- findCosineSimilarity(preChavezTokenFrequency = preChavezFrequencyMasterKeyLemmas, postChavezTokenFrequency = postChavezFrequencyMasterKeyLemmas)
cosineSimilarityLemmasKeywords
